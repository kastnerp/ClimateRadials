...
class Radial():
    ...
    def plot_line(self, size=None, dpi=600, x=None, y=None, ymin=None, ymax=None, yorigin=None, cmap=None,
        ...
        # if self.read_from_url:
        # self.delete_epw()
        print("Done.")

    def plot_bars(self, size=None, dpi=600, x=None, y=None, ymin=None, ymax=None, yorigin=None, cmap=None,
                  fileName=None, export=False):
